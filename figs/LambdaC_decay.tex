...
\nopagecolor
  \begin{tikzpicture}[node distance=0.9cm and 1.3cm, baseline=1cm]
    \coordinate[] (c0);
    \coordinate[left=of c0,label= left:{$\Lambda_c,\,\left|\frac{1}{2},\Lambda\right\rangle$}] (Lamc);
    \coordinate[above right=of c0, xshift=4mm, label=right:{$p,\,\left|\frac{1}{2},\lambda\right\rangle$}] (p);
